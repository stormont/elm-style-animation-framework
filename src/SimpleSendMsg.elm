...
createActionableAnimation how what id =
  how (what ++ [ Animation.Messenger.send (AnimationDone id) ])
...
update action model =
    case action of
        FadeInFadeOut ->
            ( { model
                | style =
                    createActionableAnimation Animation.interrupt temp "Hi!" model.style
              }
            , Cmd.none
            )
